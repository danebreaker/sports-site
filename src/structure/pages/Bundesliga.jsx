...
function Bundesliga() {
    ...
    useEffect(() => {
        fetch(`https://www.thesportsdb.com/api/v1/json/3/eventsround.php?id=4331&r=${matchday}&s=2023-2024`, {
            method: "GET"
        })
            .then(res => res.json())
    ...
    useEffect(() => {
        ...
        fetch(`https://www.thesportsdb.com/api/v1/json/3/lookuptable.php?l=4331&s=2023-2024`, {
            method: "GET"
        })
            .then(res => res.json())
            .then(data => setTable(data.table))

        fetch(`https://www.thesportsdb.com/api/v1/json/60130162/eventsnextleague.php?id=4331`, {
            method: "GET"
        })
            .then(res => res.json())
    ...
    function refreshScore() {
        fetch(`https://www.thesportsdb.com/api/v2/json/60130162/livescore.php?l=4331`, {
            method: "GET"
        })
            .then(res => res.json())
                    ...
                    <tbody>
                        {
                            table.map(team => {
                                return <tr key={team.strTeam}>
                                    <td style={{ backgroundColor: team.intRank > 16 ? "#fc3f3f" : team.intRank > 15 ? "#eab327" : team.intRank < 5 ? "#38abd8" : "white" }}>{team.intRank}</td>
                                    <td style={{ backgroundColor: team.intRank > 16 ? "#fc3f3f" : team.intRank > 15 ? "#eab327" : team.intRank < 5 ? "#38abd8" : "white" }}>{team.strTeam}</td>
                                    <td style={{ backgroundColor: team.intRank > 16 ? "#fc3f3f" : team.intRank > 15 ? "#eab327" : team.intRank < 5 ? "#38abd8" : "white" }}>{team.intPlayed}</td>
                                    <td style={{ backgroundColor: team.intRank > 16 ? "#fc3f3f" : team.intRank > 15 ? "#eab327" : team.intRank < 5 ? "#38abd8" : "white" }}>{team.intWin}</td>
                                    <td style={{ backgroundColor: team.intRank > 16 ? "#fc3f3f" : team.intRank > 15 ? "#eab327" : team.intRank < 5 ? "#38abd8" : "white" }}>{team.intDraw}</td>
                                    <td style={{ backgroundColor: team.intRank > 16 ? "#fc3f3f" : team.intRank > 15 ? "#eab327" : team.intRank < 5 ? "#38abd8" : "white" }}>{team.intLoss}</td>
                                    <td style={{ backgroundColor: team.intRank > 16 ? "#fc3f3f" : team.intRank > 15 ? "#eab327" : team.intRank < 5 ? "#38abd8" : "white" }}>{team.intPoints}</td>
                                </tr>
                            })
                        }
                    </tbody>
