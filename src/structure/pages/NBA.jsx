...
function NBA() {
    ...
    useEffect(() => {
        ...
        fetch(`https://www.thesportsdb.com/api/v1/json/60130162/eventsnextleague.php?id=4387`, {
            method: "GET"
        })
            .then(res => res.json())
    ...
    function refreshScore() {
        fetch(`https://www.thesportsdb.com/api/v2/json/60130162/livescore.php?l=4387`, {
            method: "GET"
        })
            .then(res => res.json())
