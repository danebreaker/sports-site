...
function LaLiga() {
    ...
    useEffect(() => {
        fetch(`https://www.thesportsdb.com/api/v1/json/3/eventsround.php?id=4335&r=${matchday}&s=2023-2024`, {
            method: "GET"
        })
            .then(res => res.json())
    ...
    useEffect(() => {
        ...
        fetch(`https://www.thesportsdb.com/api/v1/json/3/lookuptable.php?l=4335&s=2023-2024`, {
            method: "GET"
        })
            .then(res => res.json())
            .then(data => setTable(data.table))

        fetch(`https://www.thesportsdb.com/api/v1/json/60130162/eventsnextleague.php?id=4335`, {
            method: "GET"
        })
            .then(res => res.json())
    ...
    function refreshScore() {
        fetch(`https://www.thesportsdb.com/api/v2/json/60130162/livescore.php?l=4335`, {
            method: "GET"
        })
            .then(res => res.json())
