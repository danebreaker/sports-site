...
function USLLeagueTwo() {
    ...
    useEffect(() => {
        fetch(`https://www.thesportsdb.com/api/v1/json/3/eventsround.php?id=5077&r=${matchday}&s=2023`, {
            method: "GET"
        })
            .then(res => res.json())
    ...
    useEffect(() => {
        ...
        fetch(`https://www.thesportsdb.com/api/v1/json/3/lookuptable.php?l=5077&s=2023`, {
            method: "GET"
        })
            .then(res => res.json())
            .then(data => setTable(data.table))

        fetch(`https://www.thesportsdb.com/api/v1/json/60130162/eventsnextleague.php?id=5077`, {
            method: "GET"
        })
            .then(res => res.json())
    ...
    function refreshScore() {
        fetch(`https://www.thesportsdb.com/api/v2/json/60130162/livescore.php?l=5077`, {
            method: "GET"
        })
            .then(res => res.json())
